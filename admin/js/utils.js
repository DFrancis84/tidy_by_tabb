...
export function normalizeRecord(r={}){return{id:cleanString(r.id),title:cleanString(r.title),category:cleanString(r.category),beforeImage:cleanString(r.beforeImage),afterImage:cleanString(r.afterImage),comparisonImage:cleanString(r.comparisonImage),featured:toBoolean(r.featured),published:toBoolean(r.published),created:cleanString(r.created),updated:cleanString(r.updated)}}
